<p align="center">
<img src='http://i.imgur.com/gZ5RBFV.png' alt='PHP Email Validation Tool' />
</p>
...
The aim of this library is to offer a more detailed email validation report than simply checking if an email is the valid format, and to also make it possible to easily add custom validations. Currently this tool checks the following:
...
| Disposbale email provider^  | Checks if the email is a disposable email (e.g person@10minutemail.com).  |
...
No, none of these tests are 100% accurate. As with any email validation there will always be false postives & negatives. The only way to guarantee an email is valid is to send an email and solicit a response. However, this library is still useful for detecting disposable emails etc., and also acts as a good first line of defence.
